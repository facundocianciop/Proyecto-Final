//
//  SFReporteHeladasSectoresViewController.m
//  Smart Farming App
//
...
#import "SFReporteHeladasSectoresViewController.h"
...
@interface SFReporteHeladasSectoresViewController ()
...
@implementation SFReporteHeladasSectoresViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:kSFNavegarAReporteHeladasSeleccionarFechaSegue])
    {
        // Get reference to the destination view controller
        SFReporteHeladasFechasViewController *vc = [segue destinationViewController];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:kSFNavegarAReporteHeladasSeleccionarFechaSegue sender:self];
}
