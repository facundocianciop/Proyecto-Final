//
//  SFElegirSectorEstadoActualViewController.m
//  Smart Farming App
//
...
#import "SFElegirSectorEstadoActualViewController.h"

#import "ServiciosModuloSectores.h"

#import "SFReporteEstadoActualSectorDetalleViewController.h"

@interface SFElegirSectorEstadoActualViewController ()
...
@implementation SFElegirSectorEstadoActualViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:kSFNavegarAReporteEstadoSectorDetalleSegue])
    {
        // Get reference to the destination view controller
        SFReporteEstadoActualSectorDetalleViewController *vc = [segue destinationViewController];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:kSFNavegarAReporteEstadoSectorDetalleSegue sender:self];
}
