//
//  SFTextInputBaseViewController.h
//  Smart Farming App
//
...
@interface SFTextInputBaseViewController : SFViewControllerBase <UITextFieldDelegate, UIScrollViewDelegate, UITextViewDelegate>
