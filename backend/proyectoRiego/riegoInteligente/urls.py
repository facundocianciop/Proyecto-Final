...
urlpatterns = [
    ...
    url(r'^buscarConfiguracionesEventosPersonalizados/$', views_modulo_reportes.buscar_configuraciones_eventos_personalizados,
        name='buscarConfiguracionesEventosPersonalizados'),
    url(r'^mostrarConfiguracionEventoPersonalizado/$', views_modulo_reportes.mostrar_configuracion_evento_personalizado,
        name='mostrarConfiguracionEventoPersonalizado'),
    url(r'^mostrarTipoMedicionInternaFinca/$', views_modulo_reportes.mostrar_tipo_medicion_interna_finca,
        name='mostrarTipoMedicionInternaFinca'),
    url(r'^mostrarTipoMedicionClimaticaFinca/$', views_modulo_reportes.mostrar_tipo_medicion_climatica_finca,
        name='mostrarTipoMedicionClimaticaFinca'),
    url(r'^crearConfiguracionEventoPersonalizado/$', views_modulo_reportes.crear_configuracion_evento_personalizado,
        name='crearConfiguracionEventoPersonalizado'),
    url(r'^modificarConfiguracionEventoPersonalizado/$', views_modulo_reportes.modificar_configuracion_evento_personalizado,
        name='modifcarConfiguracionEventoPersonalizado'),
    url(r'^desactivarConfiguracionEventoPersonalizado/$', views_modulo_reportes.desactivar_configuracion_evento_personalizado,
        name='desactivarConfiguracionEventoPersonalizado'),
    url(r'^activarConfiguracionEventoPersonalizado/$', views_modulo_reportes.activar_configuracion_evento_personalizado,
