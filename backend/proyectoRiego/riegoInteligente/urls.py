...
urlpatterns = [
    ...
    url(r'^eliminarConfiguracionRiegoMecanismoRiegoFincaSector/$',
        ...
        name='cancelarRiegoManualmente'),
    url(r'^agregarCriterioConfiguracionRiegoMecanismoRiegoFincaSector/$',
        views_modulo_configuracion_riego.agregar_criterio_configuracion_riego_mecanismo_riego_finca_sector,
        name='cancelarRiegoManualmente'),
