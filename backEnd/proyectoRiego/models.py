...
class Cultivo(models.Model):
    ...
    sector_ = models.ForeignKey(Sector, db_column="OIDSector")
...
class CaracteristicaSubtipo(models.Model):
    ...
    subtipo_cultivo = models.ForeignKey(SubtipoCultivo, db_column="OIDSubtipoCultivo",
                                            related_name="caracteristica_subtipo_list")
...
class EjecucionRiego(models.Model):
    ...
    mecanismo_riego_finca_sector=models.ForeignKey(MecanismoRiegoFincaSector,db_column="OIDMecanismoRiegoFincaSector",related_name="ejecucion_riego_list")
...
class MedicionEstadoExterno(models.Model,MedicionEvento):
   #HERENCIA
...
class MediciónInformaciónClimáticaCabecera(models.Model):
    ...
    proveedor_informacion_climatica_externa=models.ForeignKey(ProveedorInformacionClimaticaFinca,db_column="OIDProveedorInformacionClimaticaFinca",related_name="medicion_informacion_climatica_cabecera_list")
